...
def main():
    ...
    # using the open function from the Image module
    img = Image.open(r"Unit6\ex6p4.jpg")
    draw = ImageDraw.Draw(img)

    # draw the first line of the image 
    # using the draw function from the ImageDraw module
    draw.line(first, fill='red', width=10)
    draw.polygon(first, fill='black')

    # draw the second line of the image 
    # using the draw function from the ImageDraw module
    draw.line(second, fill='red', width=10)
    draw.polygon(second, fill='black')

    # save the image
    # using the save function from the Image module
    img.save(r"Unit6\ex6p4_with_first_line.jpg")
    img.show()
